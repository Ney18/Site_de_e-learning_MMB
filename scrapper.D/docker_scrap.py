...
class VideoDocker() :
    ...
    logging.basicConfig(filename = "docker_scrap.log", 
                        level= logging.DEBUG, 
    ...
    def docker_link(self):
        ...
        try:
            self.docker_list_link = ["""<iframe width="560" height="315" src="https://www.youtube.com/embed/fqMOX6JJhGo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>""", """<iframe width="560" height="315" src="https://www.youtube.com/embed/X48VuDVv0do" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>""", """<iframe width="560" height="315" src="https://www.youtube.com/embed/m3cKkYXl-8o" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>"""]
        except Exception as e:
    ...
    def docker_title(self):
        ...
        try:
            self.docker_list_title = ["""Docker Tutorial for Beginners - A Full DevOps Course on How to Run Applications in Containers""", "Kubernetes Tutorial for Beginners", "Terraform Tutorial | Terraform Course Overview"]
        except Exception as e:
    ...
    def docker_youtuber(self):
        ...
        try:
            self.docker_list_youtuber = ["freeCodeCamp.org", "TechWorld with Nana", "TechWorld with Nana"]
        except Exception as e:
            logging.error("[DOCKER] Error in docker youtuber list !!!! " +str(e))
    ...
    def docker_duration(self):
        ...
        try:
            ...
            logging.error("[DOCKER] Error in docker duration list !!!! " +str(e))
    ...
    def docker_zip(self):
        ...
        try:
            self.docker_zip_list = list(zip(self.docker_list_link, self.docker_list_title, self.docker_list_youtuber, self.docker_list_duration, self.docker_list_vue, self.docker_list_theme))
        except Exception as e:
